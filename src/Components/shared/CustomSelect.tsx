...
export const CustomSelect = ({
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
      <div
        className={cn(
          "w-full h-11 bg-neutral-50 dark:bg-zinc-900 border border-neutral-200 dark:border-white/10 dark:text-white rounded-xl px-4 flex items-center justify-between cursor-pointer transition-all outline-none",
