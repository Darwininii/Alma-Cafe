  ...
  return (
    <div className="w-[120px] lg:w-[280px] flex flex-col gap-6 items-center py-6 fixed h-screen bg-gradient-to-b from-neutral-900/98 via-neutral-900/95 to-black/90 dark:from-black/95 dark:via-black/90 dark:to-neutral-950/95 backdrop-blur-3xl border-r border-white/10 shadow-[4px_0_32px_rgba(0,0,0,0.3)] z-50 transition-all duration-500">
      ...
      <div className="w-full px-12 flex justify-center py-4 border-b border-white/10 relative group cursor-pointer">
        ...
        {/* Logo glow effect */}
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl pointer-events-none" />
      </div>
      ...
      <nav className="w-full space-y-2 flex-1 overflow-y-auto px-8 py-1 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        {dashboardLinks.map((link) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn(
                ...
                isActive
                  ? "bg-gradient-to-r from-primary/30 via-primary/20 to-primary/10 text-primary shadow-[0_0_30px_rgba(234,88,12,0.25),inset_0_0_20px_rgba(234,88,12,0.1)] ring-2 ring-primary/40 scale-105"
          ...
          >
            ...
            {/* Glow on hover */}
            <div className="absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/20 to-primary/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl" />
          </NavLink>
        ))}
      </nav>
      ...
      <div className="w-full px-12 pt-3 border-t border-white/10">
        <CustomButton
          ...
          className={cn(
            ...
            "!bg-transparent bg-gradient-to-br from-white/5 to-white/10 dark:from-white/10 dark:to-white/5",
